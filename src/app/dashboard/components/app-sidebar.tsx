...
const DeepsightIcon = ({ className }: { className?: string }) => (
  <svg width="20" height="20" viewBox="0 0 513 513" fill="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              <Link href="#">
                <DeepsightIcon />
                <span className="text-base font-semibold">Deepsight</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
