...
export function SiteHeader() {
  ...
  return (
    <header className="bg-background/90 sticky top-0 z-10 flex h-[50px] shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-[--header-height]">
      <div className="flex w-full items-center gap-1 px-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button 
            ...
            className="h-7 bg-slate-900 text-white hover:bg-slate-800 disabled:bg-slate-400 disabled:cursor-not-allowed"
          >
