...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-4 border-none shadow-lg rounded-lg", className)}
      classNames={{
        ...
        nav_button: cn(
          "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-none focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
        ...
        day_today: 
          "bg-slate-100 text-slate-900 aria-selected:text-slate-50 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
